...
| Sequential Fine-Tuning | Lower bound | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | Unified frozen CLIP head/component update | Preserve audited backbone | Exact optimizer and head reset |
| LwF | Distillation | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | Distill under frozen CLIP | Preserve audited backbone | Paper/source/version |
| EWC | Regularization | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | Apply audited penalty to Track A trainables | Preserve audited backbone | Fisher estimation details |
...
| AGCN | Static EMOTIC | TBD | TBD | TBD | TBD | EMOTIC (TBD) | TBD | TBD | TBD | TBD | Incremental wrapper on frozen CLIP | Incrementalize audited original | Legal source and incremental design |
