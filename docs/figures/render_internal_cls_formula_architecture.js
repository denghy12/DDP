...
async function main() {
  ...
  const pngPath = path.join(root, 'code_ddp_internal_cls_fixed_global_alpha_formula_architecture.png');
  const pdfPath = path.join(root, 'code_ddp_internal_cls_fixed_global_alpha_formula_architecture.pdf');
